...
| [**Keeping 1차 — 웹 재고·발주 자동화 플랫폼**](https://leeedd00.github.io/projects/keeping-web/) | 도매시장 시세를 매장 단위 수요로 바꾸는 전처리 파이프라인과 앙상블 수요예측 모델(MAPE 29%→16%), 린스타트업 스쿨 MVP 앱 외주 발주 (2025) |
