...
| 프로젝트 | 설명 | 기술 스택 | 기간 / 역할 | 링크 |
|----------|------|-----------|-------------|------|
| **Keeping — AI 매장 비서** | 소규모 식당의 재고를 모니터링하고, 재고 부족·소비기한 임박을 자동 감지해 발주 초안을 만들어 주는 모바일 앱 | Expo (React Native), FastAPI, SQLAlchemy, Supabase PostgreSQL, Docker | ( 빈칸 ) | ( 빈칸: GitHub 링크 ) |
| ( 빈칸 ) | ( 빈칸 ) | ( 빈칸 ) | ( 빈칸 ) | ( 빈칸 ) |
| ( 빈칸 ) | ( 빈칸 ) | ( 빈칸 ) | ( 빈칸 ) | ( 빈칸 ) |

<details>
<summary><b>📌 Keeping 자세히 보기</b></summary>
<br />

- **문제**: ( 빈칸: 어떤 문제를 해결하려고 했는지 )
- **내가 한 일**: ( 빈칸: 담당한 기능 / 역할 )
- **배운 점**: ( 빈칸 )
- **성과**: ( 빈칸: 수치, 사용자 반응 등 )
...
| 2024.09 – 2024.12 | 동남권 창업동아리: 노인 전용 양갱 제작, 시제품 품평회 (장려상, 인기상) |
| 2025.01 – 2025.12 | 유통물류학과 학생회 총무 |
| 2025.07 – 2025.08 | La Salle University 어학연수 |
| 2025.09 – 2025.12 | 린스타트업: 재고관리 어플 외주 |
...
<div align="center">
  ...
  <a href="https://github.com/leeedd00"><img src="https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white" /></a>
  <!-- 아래 링크는 빈칸: 주소 채우면 활성화 -->
  <a href="( 빈칸: 블로그 URL )"><img src="https://img.shields.io/badge/Blog-20C997?style=for-the-badge&logo=velog&logoColor=white" /></a>
  <a href="( 빈칸: LinkedIn URL )"><img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" /></a>
</div>
